...
namespace ChatApp.Persistence.Migrations
{
    ...
    [Migration("20240417145257_identity_tables")]
            ...
            modelBuilder.Entity("ChatApp.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Content = "test-one",
                            IsActive = true,
                            MessageSend = new DateTime(2024, 4, 17, 14, 52, 57, 29, DateTimeKind.Utc).AddTicks(6033),
                        ...
                        new
                        {
                            ...
                            Content = "test-two",
                            IsActive = true,
                            MessageSend = new DateTime(2024, 4, 17, 14, 52, 57, 29, DateTimeKind.Utc).AddTicks(6045),
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RecipientDeleted = false,
                            RecipientId = 1,
                            RecipientUserName = "ahmed",
                        ...
                        new
                        {
                            ...
                            Content = "test-two",
                            IsActive = true,
                            MessageSend = new DateTime(2024, 4, 17, 14, 52, 57, 29, DateTimeKind.Utc).AddTicks(6047),
                            ModifiedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RecipientDeleted = false,
                            RecipientId = 1,
                            RecipientUserName = "ahmed",
